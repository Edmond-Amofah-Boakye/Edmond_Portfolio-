...
export const skills = {
  ...
  "Frontend": ["React.js", "HTML5", "CSS3", "Tailwind CSS", "Ant Design", "Responsive Design"],
  ...
  "Databases": ["MongoDB", "PostgreSQL", "MySQL", "Microsoft SQL Server", "Redis", "SQL", "Database Design"],
